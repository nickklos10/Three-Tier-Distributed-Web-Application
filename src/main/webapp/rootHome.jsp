...
<head>
    <meta charset="UTF-8">
    <title>Project 4 Enterprise System - Root User</title>
    <style>
        /* Common styles */
        body {
...
<p class="info-text">You are connected to the Project 4 Enterprise System database as a root-level user.</p>
...
<script>
    ...
    // Function to display messages in a green box
    function displayGreenBox(messages) {
        let html = '<div class="green-box">';
            ...
            .then(text => {
                ...
                if (data.error) {
                    ...
                    let messages = [
                        ...
                        data.updateCount + ' row(s) affected'
                    ];

                    if (data.businessLogic) {
                        messages.push(data.businessMessage);
                        messages.push('Business logic updated ' + data.suppliersUpdated + ' supplier status marks');
                    }

                    let content = displayGreenBox(messages);
