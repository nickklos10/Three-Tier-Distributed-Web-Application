# Client creation and permission assignment script for CNT 4714 Project 4 - Fall2024
...
# If any of these clients are currently connected, the drop user command will not take effect until that user's connection is terminated.
